...
function titleLoad()
	...
	bgm = love.audio.newSource("bgm/CyborgNinja.ogg", "static")
	bgm:play()
	punch = {}
	punch[1] = love.audio.newSource("sfx/punch1.wav", "static")
	punch[2] = love.audio.newSource("sfx/punch2.wav", "static")
	punch[3] = love.audio.newSource("sfx/punch3.wav", "static")
	punch[4] = love.audio.newSource("sfx/punch4.wav", "static")
	punch[5] = love.audio.newSource("sfx/punch5.ogg", "static")
	punch[6] = love.audio.newSource("sfx/punch6.wav", "static")
	punch[7] = love.audio.newSource("sfx/punch7.wav", "static")
end -- titleLoad()
